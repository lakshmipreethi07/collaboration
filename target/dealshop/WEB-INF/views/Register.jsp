...
<body
  ...
  <div class="form-group">
    <label class="control-label col-xs-4"  for="inputSuccess2"><spring:message text="userid:"/></label>
    <div class="col-xs-4"> 
      <%Random r=new Random();
      int userid=r.nextInt(99999);
      %>
      <input type="text" value="<%=userid%>" class="form-control" id="inputSuccess2" name="id" required="true"/>
  ...
  <div class="form-group">
    ...
    <div class="col-xs-4"> 
      <input type="number" class="form-control" name="mobile" required="true" pattern="[789][0-9]{9}" title="Please enter valid mobile number">
    </div>
  </div><br>
  <div class="form-group">
